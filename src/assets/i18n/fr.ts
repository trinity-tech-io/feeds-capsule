export const fr = {
    ...
    "ScanqrcodePage": {
        ...
        "introduce1": "Make sure you have already installed the Feeds Service on your local device. Scan the QR code displayed on the local browser.",
    ...
    "IssuecredentialPage": {
        ...
        "introduce2": "You have published the payload to the DID sidechain successfully.",
        "introduce3": "In order to claim the ownership,you have to issue your credentials.",
    ...
    "CollectionsPage":{
        ...
        "purchased": "Purchased",
        "likes": "Likes",
        "emptylikes": "Give a like to collectibles you like",
