export const zh = {
    ...
    "AddServerPage":{
        ...
        // "serverAddedSuccess": "添加Feeds出版号成功，您可以订阅里面的Feeds了",
        // "Signinsuccess": "登录成功!",
        "scanimg": "导入二维码图片",
        "tipMsg1": "未发现二维码",
      },
    ...
    "ScanqrcodePage":{
        ...
        "introduce1": "请确保您已启动Feeds出版号节点服务，且通过浏览器已显示Feeds出版号二维码。",
    ...
    "FinishPage": {
        "introduce": "Feeds出版号绑定成功。恭喜您有了属于自己的Feeds出版号服务，现在您可以开始创建频道。",
        "introduce1": "新建频道",
        "introduce2": "返回主页面",
    },
    "CreatenewpostPage":{
