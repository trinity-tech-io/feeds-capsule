export const zh = {
  common: {
    ...
    uploadingData: '正在上传Collectible数据到IPFS网络',
    uploadDataSuccess: 'Collectible数据上传到IPFS网络完成',
    uploadDataFail: 'Collectible数据上传到IPFS网络失败',
    mintingData: '创建NFT Collectible过程中',
    mintDataSuccess: '创建NFT Collectible 成功',
    mintDataFail: '创建NFT Collectible失败',
    settingApproval: '等待授权委托NFT Collectible到Pasar合约处理',
    agreeApproval: '同意授权委托NFT Collectible给Pasar合约处理',
    disagreeApproval: '拒绝授权委托NFT Collectible给Pasar合约，终止出售NFT Collectible',
    ...
    publishSameDataFailed: '失败 : 收藏品 中已经有相同的收藏品',
    savePicture: "保存收藏品",
    ...
    sharePasar: "正在分享收藏品 ",
    parsing: "正在解析...",
    orderCantFind: "无法在 Pasar 商场中找到该收藏品出售",
    hasBeenSold: "该收藏品在Pasar商场已出售",
    orderHasBeenCancel: "该收藏品在Pasar商场已下架",
    orderInvalid: "该收藏品在Pasar商场中状态异常",
  ...
  StartbindingPage: {
    ...
    linkServer:
      '您正在关联一个Feeds出版号，请确认Feeds出版号URL网址与之前绑定的Feeds出版号是否一致。',
    confirm: '确认一致，继续',
    abort: '校验码不一致，中止绑定',
  ...
  IntroducePage: {
    ...
    des3: '网站',
    des4:
      '中下载最新版本。 您需要安装并运行Feeds服务来接收QR码，以便绑定出版号。',
    des5: '这是Feeds的工作方式：拥有出版号的用户可以发布微说，创建收藏品等；',
    des6: '如果没有出版号，用户只能阅读微说，而不能发布或编辑微说。',
    des7: '什么是出版号？',
    des8:
      '将数据绑定到Feeds服务的帐户。想象一下，如果您是图书出版商，则有权在市场上编写、编辑和出版图书，而普通读者只能在书店中阅读和浏览图书。',
    next: '好',
    info: '#信息',
    back: '返回',
  },
