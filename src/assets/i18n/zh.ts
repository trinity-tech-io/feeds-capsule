export const zh = {
  common: {
    ...
    timeout: '超时',
    mintTimeoutDesc: '创建收藏品超时，后面您可自行确认创建收藏品是否成功',
  ...
  NftdisclaimerComponent: {
    ...
    des7: '7. 因侵权（包括疏忽）、违约或任何其他原因造成的任何间接、特殊或附带的损失或损害，无论该等损失或损害是否可由 Feeds 团队合理预见，也无论 Feeds团队已被提前通知此类损失或损害的可能性。',
    des8: '8. 任何非由Feeds团队造成的与Feeds Parser平台提供的服务相关的任何其他损失；',
    des9: '9、Feeds团队对Feeds Parser平台服务的使用不作任何明示或暗示的保证，包括但不限于：本平台所提供服务的适用性、错误或遗漏、连续性、准确性、可靠性，以及对特定用途的适用性。此外，Feeds 团队对Feeds Parser 平台提供的服务相关的技术和信息的有效性、准确性、正确性、可靠性、质量、稳定性、完整性或及时性不作任何承诺或保证。使用本平台提供的服务是用户个人选择，风险自负。Feeds 团队不对数字资产的市场、价值或价格做出任何明确或暗示的保证。请注意，数字资产市场不稳定，市场随时可能出现波动或崩盘。交易数字资产是用户的个人选择，风险自负，用户应能够独立承担任何潜在的损失',
