...
export class HiveVaultHelper {
    ...
    private insertPostData(postId: string, channelId: string, tag: string, content: string, type: string, status: number, memo: string, proof: string, createdAt: number, updatedAt: number): Promise<string> {
        return new Promise(async (resolve, reject) => {
            try {
    ...
    publishPost(postId: string, channelId: string, tag: string, content: string, type: string = 'public', status: number = FeedsData.PostCommentStatus.available, memo: string, proof: string, createdAt: number, updatedAt: number): Promise<string> {
        return this.insertPostData(postId, channelId, tag, content, type, status, memo, proof, createdAt, updatedAt);
    }
    /** publish post end */
